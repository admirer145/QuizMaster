...
router.get('/', authenticateToken, (req, res) => {
    ...
    if (filter === 'all') {
        // ... (existing 'all' logic, but with public check)
        // I'll keep the 'all' logic but ensure it respects the new whereConditions
        ...
        firstQuery += ` ORDER BY r.score DESC LIMIT ? OFFSET ?`;
